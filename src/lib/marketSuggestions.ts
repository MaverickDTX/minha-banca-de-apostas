...
const MARKETS_BY_SPORT: Record<string, string[]> = {
  Futebol: [
    ...
    "Jogador para Marcar de Cabeça",
    "Jogador para Marcar de Fora da Área",
    ...
    "Chutes do Time",
    "Chutes do Time 1º Tempo",
    "Chutes ao Gol do Time",
    "Chutes da Partida",
    "Chutes ao Gol da Partida",
    "Handicap de Chutes do Time",
    "Chutes para Fora do Jogador",
    "Chutes ao Gol de Fora da Área do Jogador",
    "Cabeceios do Jogador",
    "Cabeceios ao Gol do Jogador",
    "Desarmes do Jogador",
    "Desarmes do Time",
    "Impedimentos do Time",
    "Impedimentos da Partida",
    "Faltas Sofridas pelo Jogador",
    "Faltas Cometidas pelo Jogador",
    "Faltas Cometidas pelo Time",
    "Defesas do Goleiro",
    "Empate Anula (DNB)",
    "Vencedor do Torneio",
    "Criar Aposta",
  ...
  Tênis: [
    ...
    "Games do Jogador",
    "Aces do Jogador",
    "Quebras de Serviço do Jogador",
    "Quebras de Serviço da Partida",
    "Quebras de Serviço no 1º Set",
    "Jogador com Mais Duplas Faltas",
    "Duplas Faltas do Jogador",
    "Duplas Faltas da Partida",
    "Vencedor do Torneio",
    "Criar Aposta",
  ],
  Automobilismo: [
  ...
  Basquete: [
    ...
    "Total de Pontos 1º Tempo",
    "Vencedor do 1º Quarto",
    "Vencedor do 1º Tempo",
    "Pontos do Jogador",
    "Pontos do Jogador 1º Quarto",
    "Rebotes do Jogador",
  ...
  "Futebol Americano": [
    ...
    "Jardas Corridas da Partida",
    "Tentativas de Passe do Jogador",
  ...
  "Beisebol": [
    ...
    "Corridas do Jogador",
    "Total de Bases do Jogador",
    "Corridas no 1º Inning",
    "Outs do Lançador",
    "Vencedor do Torneio",
    "Criar Aposta",
  ],
  "Hóquei no Gelo": [
    "Vencedor (Moneyline)",
    "Vencedor do 1º Período",
    "Puck Line (Handicap)",
    "Total de Gols (Over/Under)",
    "Total de Gols 1º Período",
    "Ambos Marcam",
    "Gols do Jogador",
    "Assistências do Jogador",
    "Pontos em Powerplay do Jogador",
    "Vencedor do Torneio",
    "Criar Aposta",
  ],
  "Handebol": [
